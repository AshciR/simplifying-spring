...
public class SpringImplicitConfigRunner implements Runner {
    ...
    public void run() {
        ...
        // based on what we defined in the ComponentScanHospitalConfig file.
        ApplicationContext ctx = new AnnotationConfigApplicationContext(ComponentScanHospitalConfig.class);
